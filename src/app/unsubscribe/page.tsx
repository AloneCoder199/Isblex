...
// 1. Core logic aur UI ko alag component mein rakh diya
...
// 2. Main exported component jo Next.js build engine ko crash hone se bachaye ga
export default function UnsubscribePage() {
  return (
    <section className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-4 font-sans">
      <Suspense fallback={<div className="text-[#22D3EE] font-mono text-sm">[ INITIALIZING TERMINAL... ]</div>}>
        <UnsubscribeForm />
      </Suspense>
    </section>
  );
